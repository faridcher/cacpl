...
![step-length and turn-angle distribution in high contrast situation](figures/movehmm1.png)
...
![Von-mises distribution for various concentration values](von_mises.png){width=50%}
